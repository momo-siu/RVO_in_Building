...
public class Agent {
    ...
    void computeNewVelocity() {
        ...
        final double invTimeHorizonObstacle = 1.0f / timeHorizonObstacles;
        ...
        for (final Pair<Double, Agent> agentNeighbor : agentNeighbors) {
            ...
            //System.out.println("this-agent: " + id + ")" + position + ", other-agent: " + other.id + ")" + other.position + ", relative-pos: " +relativePosition + ", relative-veloc: " + relativeVelocity);
